        ...
        <div className=" max-w-6xl mx-auto py-10">
            <div className=" md:w-3/6 mx-10">
                ...
                <div className=" flex items-center mt-5">
                    <a href="#" className=" px-5 bg-white shadow-lg rounded-md py-3 mr-5 md:mr-10 text-blue-500 font-medium "> <GooglePlayFillIcon className=' inline-flex'/> Google Play</a>
                    <a href="#" className="  px-5  bg-black py-3 rounded-md text-white font-medium shadow-lg"> <AppsFillIcon className=' inline-flex' />  App Store</a>
                </div>
            </div>
        </div>
    </div>
